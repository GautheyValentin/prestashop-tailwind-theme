      ...
      <div class="flex flex-col w-full sm:w-5/12 p-5">
        ...
        <div class="mt-5">
          {block name='product_description_short'}
            <div id="product-description-short-{$product.id}" class="text-sm" itemprop="description">
        ...
        <div class="max-w-screen-lg mx-auto px-5" x-data="{ selectedKey: description }">
          <ul class="flex space-x-4" role="tablist">
            ...
            {if $product.description}
              <li class="">
                <button @click="selectedKey = description" class="{if $product.description} {/if}" role="tab"
                  aria-controls="description" {if $product.description} aria-selected="true" {/if}>
            ...
            {if $product.attachments}
              <li class="">
                <button @click="selectedKey = attachments" class="" role="tab" aria-controls="attachments">
            ...
            {foreach from=$product.extraContent item=extra key=extraKey}
              <li class="">
                <button @click="selectedKey = extra-{$extraKey}" class="" role="tab" aria-controls="extra-{$extraKey}">
                  {$extra.title}
                </button>
              </li>
            {/foreach}
          ...
          <div class="mt-5" id="tab-content">
            ...
            {foreach from=$product.extraContent item=extra key=extraKey}
              <div x-show="selectedKey === extra-{$extraKey}" class="content-style {$extra.attr.class}" id="extra-{$extraKey}"
